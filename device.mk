...
PRODUCT_COPY_FILES += \
    ...
    device/huawei/angler/audio/sound_trigger_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/sound_trigger_platform_info.xml \
...
ifneq ($(filter angler% statix_angler%, $(TARGET_PRODUCT)),)
PRODUCT_PROPERTY_OVERRIDES += \
